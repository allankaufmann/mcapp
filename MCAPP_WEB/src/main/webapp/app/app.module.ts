...
import { McappWebCoreModule } from 'app/core';
import { McappWebAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        McappWebAppRoutingModule,
        Ng2Webstorage.forRoot({ prefix: 'jhi', separator: '-' }),
        McappWebSharedModule,
        McappWebCoreModule,
        McappWebHomeModule,
        McappWebAccountModule,
        McappWebEntityModule,
        McappWebNutzungModule,
        McappWebAuswertungFragenModule
...
export class McappWebAppModule {
