...
@Component({
    ...
    templateUrl: './auswertung-frage.component.html'
})
export class AuswertungFrageComponent implements OnInit, OnDestroy {
    ...
    constructor(
        private quizFrageService: AuswertungFrageService,
