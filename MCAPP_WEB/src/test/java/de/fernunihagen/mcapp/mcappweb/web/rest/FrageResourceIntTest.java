...
public class FrageResourceIntTest {
    ...
    private static final String DEFAULT_FRAGE_TEXT = "AAAAAAAAAA";
    private static final String UPDATED_FRAGE_TEXT = "BBBBBBBBBB";
    ...
    public void createFrage() throws Exception {
        ...
        assertThat(testFrage.getFrageText()).isEqualTo(DEFAULT_FRAGE_TEXT);
    ...
    public void getAllFrages() throws Exception {
        ...
        restFrageMockMvc.perform(get("/api/frages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].frageText").value(hasItem(DEFAULT_FRAGE_TEXT.toString())))
    ...
    public void getFrage() throws Exception {
        ...
        restFrageMockMvc.perform(get("/api/frages/{id}", frage.getId()))
            ...
            .andExpect(jsonPath("$.frageText").value(DEFAULT_FRAGE_TEXT.toString()))
    ...
    public void updateFrage() throws Exception {
        ...
        Frage testFrage = frageList.get(frageList.size() - 1);
        assertThat(testFrage.getFrageText()).isEqualTo(UPDATED_FRAGE_TEXT);
