...
describe('Service Tests', () => {
    describe('Antwort Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Antwort(0, 0, 0, false, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Antwort', async () => {
            ...
            it('should update a Antwort', async () => {
                const returnedFromService = Object.assign(
                    {
                        antwortID: 1,
                        position: 1,
            ...
            it('should return a list of Antwort', async () => {
                const returnedFromService = Object.assign(
                    {
                        antwortID: 1,
                        position: 1,
            ...
            it('should delete a Antwort', async () => {
