...
public class QuizResourceIntTest {
    ...
    private static final Long UPDATED_QUIZ_ID = 2L;
     ...
     *
     * @see de.fernunihagen.mcapp.mcappweb.repository.search.QuizSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final QuizResource quizResource = new QuizResource(quizRepository, mockQuizSearchRepository);
    ...
    public void createQuiz() throws Exception {
        ...
        assertThat(testQuiz.getQuizID()).isEqualTo(DEFAULT_QUIZ_ID);
        assertThat(testQuiz.getDatum()).isEqualTo(DEFAULT_DATUM);
    ...
    public void getAllQuizzes() throws Exception {
        ...
        restQuizMockMvc.perform(get("/api/quizzes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].quizID").value(hasItem(DEFAULT_QUIZ_ID.intValue())))
    ...
    public void getQuiz() throws Exception {
        ...
        restQuizMockMvc.perform(get("/api/quizzes/{id}", quiz.getId()))
            ...
            .andExpect(jsonPath("$.quizID").value(DEFAULT_QUIZ_ID.intValue()))
    ...
    public void updateQuiz() throws Exception {
        ...
        Quiz testQuiz = quizList.get(quizList.size() - 1);
        assertThat(testQuiz.getQuizID()).isEqualTo(UPDATED_QUIZ_ID);
        assertThat(testQuiz.getDatum()).isEqualTo(UPDATED_DATUM);
    ...
    public void searchQuiz() throws Exception {
        // Initialize the database
        quizRepository.saveAndFlush(quiz);
        when(mockQuizSearchRepository.search(queryStringQuery("id:" + quiz.getId())))
            .thenReturn(Collections.singletonList(quiz));
        // Search the quiz
