...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(de.fernunihagen.mcapp.mcappweb.domain.Antwort.class.getName(), jcacheConfiguration);
            cm.createCache(de.fernunihagen.mcapp.mcappweb.domain.Antwort.class.getName() + ".frageIDS", jcacheConfiguration);
